...
prom.start()
cloud0 = net.addDocker('cloud.0', ip='10.0.0.1', dimage="abh15/mlfo:meter")#,ports=[8000], port_bindings={8000:8999}, publish_all_ports=True)
cloud0.start()
bgtserver = net.addDocker('appserv.0', ip='10.0.0.2', dimage="abh15/mlfo:meter")
bgtserver.start()
...
mlfonode = net.addDocker("mo.1", ip="10.0.1.1", dimage="abh15/mlfo:meter", ports=[8000], port_bindings={8000:intentport}, publish_all_ports=True)
mlfonode.start()
bgtapp1 = net.addDocker("app.1", ip="10.0.1.2", dimage="abh15/mlfo:meter")
bgtapp1.start()
...
for sw in range(1, 6):
    ...
    for fcli in range(0,10):
        fclient = net.addDocker("fc."+ str(sw)+ str(fcli), ip="10.0.1." + str(sw)+ str(fcli), dimage="abh15/flwr:eval")
        fclient.start()
...
for cohort in range (1, numcohorts+1):
    csw = net.addSwitch("csw"+str(cohort),cls=OVSSwitch,protocols="OpenFlow13")
    fedserver = net.addDocker("fed."+ str(cohort), ip='10.0.'+str(cohort+10)+"."+str(100), dimage="abh15/flwr:eval")
    fedserver.start()
    net.addLink(fedserver, csw, bw=500)
    net.addLink(csw, aggsw, bw=500)
