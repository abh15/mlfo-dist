...
for cohort in range (1, numcohorts+1):
    ...
    fedserver.start()
    net.addLink(fedserver, aggsw, bw=150)

net.addLink(cloud0, aggsw, bw=150)

net.addLink(prom, aggsw, bw=150)
net.addLink(bgtserver, aggsw, bw=150)
net.addLink(satsw, aggsw, cls=TCLink, delay="12ms", bw=150)
...
net.addLink(mlfonode, edgesw, bw=150)
net.addLink(bgtapp1, edgesw, bw=150)
...
for sw in range(1, 6):
    ...
    for fcli in range(0,10):
        ...
        fclient.start()
        net.addLink(fclient, campsw, bw=150)
    net.addLink(campsw, edgesw, bw=150)

net.addLink(edgesw, satsw, cls=TCLink, delay="12ms", bw=150)
